...
- Translation structure and key names
...
**File**: [GAME_TRANSLATION_CHECKLIST.md](GAME_TRANSLATION_CHECKLIST.md)
...
- How to translate UI, tutorials, and content
- Critical step: Adding game cards to main page
- Pre-release checklist
- Common mistakes to avoid

**Example**: "I'm building Phase 6 Shopping List game, what translations do I need?"

---

### 3. **Implementation Reference** 📖

**File**: [TRANSLATION_IMPLEMENTATION_SUMMARY.md](TRANSLATION_IMPLEMENTATION_SUMMARY.md)

**Use this for:**
- Understanding how the translation system works
- Technical implementation details
- Troubleshooting translation issues
- Code examples and patterns

**What you'll learn:**
- How Apply Language button works
...
│  └─ ✅ Use GAME_TRANSLATION_CHECKLIST.md
│
└─ 🔧 Understand HOW IT WORKS or FIX ISSUES
   └─ ✅ Use TRANSLATION_IMPLEMENTATION_SUMMARY.md
```
